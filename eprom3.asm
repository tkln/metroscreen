...
;
        ...
        db      07FH, 07FH, 010H, 030H      ; "   0"
        db      07FH, 07FH, 017H, 07FH      ; "    "
        db      07FH, 010H, 031H, 07FH      ; "  1 "
        db      07FH, 017H, 07FH, 07FH      ; "    "
        db      017H, 07FH, 07FH, 005H      ; "    "
        db      07FH, 07FH, 017H, 05AH      ; "   Z"
        db      03AH, 020H, 020H, 041H      ; ":  A"
        db      03AH, 020H, 020H, 048H      ; ":  H"
        db      009H, 053H, 04BH, 041H      ; " SKA"
        db      04EH, 044H, 049H, 02EH      ; "NDI."
        db      046H, 04EH, 054H, 020H      ; "FNT "
        db      000H, 043H, 068H, 065H      ; " Che"
        db      063H, 06BH, 03AH, 020H      ; "ck: "
        db      049H, 06EH, 069H, 074H      ; "Init"
        db      02EH, 020H, 04DH, 065H      ; ". Me"
        db      06DH, 06FH, 072H, 079H      ; "mory"
        db      000H, 055H, 04CH, 041H      ; " ULA"
        db      04DH, 02DH, 048H, 030H      ; "M-H0"
        db      047H, 009H, 056H, 03AH      ; "G V:"

;        db      032H, 037H, 02EH, 031H      ; "27.1"
;        db      030H, 02EH, 039H, 034H      ; "0.94"
        db      048H, 061H, 063H, 06BH      ; "Hack"
        db      06CH, 061H, 062H, 020H      ; "lab "

        db      000H, 020H, 000H, 054H      ; "   T"
        db      065H, 073H, 074H, 03AH      ; "est:"
        db      009H, 053H, 050H, 041H      ; " SPA"
        db      020H, 020H, 020H, 000H      ; "    "
        db      003H, 057H, 044H, 02DH      ; " WD-"
        db      054H, 065H, 073H, 074H      ; "Test"
        ...
        db      0B5H, 0B6H, 0B5H, 0B6H      ; "    "
        db      0B5H, 0B6H, 000H, 017H      ; "    "
        db      04DH, 048H, 045H, 04CH      ; "MHEL"
        db      053H, 017H, 040H, 049H      ; "S @I"
        db      02EH, 017H, 040H, 045H      ; ". @E"
        db      02BH, 02EH, 017H, 040H      ; "+. @"
        db      045H, 02DH, 02EH, 017H      ; "E-. "
        db      040H, 052H, 02EH, 017H      ; "@R. "
;
L0192:
        dcx     b
        in      011H
...
;--------------------------------
; Blinky
; vilkuttaa 8155:n PC0:aan kytkettyä lediä
;loop:
;       mvi     a,01H
;        out     43H
;
...
;------------------------------------------------
; Scroller
; skrollaa test_text:iä näytöllä
...
test_text:
;                Timbuktuun
;         db      20H, 20H, 20H, 20H, 20H, 20H, 20H, 54H, 69H, 6DH, 62H, 75H, 6BH, 74H, 75H, 75H, 6E, 00H
;                Helsinki
        db      20H, 48H, 65H, 6CH, 73H, 69H, 6EH, 6BH, 69H, 20H
;                Hacklab
        db      48H, 61H, 63H, 6BH, 6CH, 61H, 62H, 20H
;                14.3.2013
;        db      31H, 34H, 2EH, 33H, 2EH, 32H, 30H, 31H, 33H, 00H
        db      32H, 30H, 31H, 33H, 2DH, 30H, 33H, 2DH, 31H, 34H, 20H, 48H, 65H, 6CH, 6CH, 6FH, 20H
        db      57H, 6FH, 72H, 6CH, 64H, 21H, 20H, 20H, 20H, 20H, 20H, 00H

; poistettu useita kilotavuja DB 0FFH        
